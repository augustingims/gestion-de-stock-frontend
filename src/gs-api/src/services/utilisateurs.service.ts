...
class UtilisateursService extends __BaseService {
  static readonly currentUserPath = '/gestiondestock/v1/utilisateurs/account';
  ...
  static readonly changePasswordPath = '/gestiondestock/v1/utilisateurs/update/password';
  ...
  currentUserResponse(): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/utilisateurs/account`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  changePasswordResponse(body?: ChangerMotDePasseUtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @return successful operation
   */
  changePassword(body?: ChangerMotDePasseUtilisateurDto): __Observable<UtilisateurDto> {
